...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Analysis Images</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{$laboratories->Patient->name}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="form-group">
        <label for="exampleFormControlTextarea1">Laboratory Doctor's Notes</label>
