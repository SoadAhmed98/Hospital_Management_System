...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Laboratory</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Employee List</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                            ...
                            <tbody>
                                @foreach($laboratorie_employees as $laboratorie_employee)
                                    <tr>
                                        ...
                                        <td>
                                            @if($laboratorie_employee->created_at)
                                                {{ $laboratorie_employee->created_at->diffForHumans() }}
                                            @else
                                                N/A
                                            @endif
                                        </td>
