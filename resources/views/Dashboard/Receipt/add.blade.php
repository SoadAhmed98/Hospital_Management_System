...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Accounts</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Add New Receipt Voucher</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{ route('Receipt.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control {{ $errors->has('Debit') ? 'is-invalid' : '' }}" name="Debit" type="number" value="{{ old('Debit') }}">
                                    @if($errors->has('Debit'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('Debit') }}
                                        </div>
