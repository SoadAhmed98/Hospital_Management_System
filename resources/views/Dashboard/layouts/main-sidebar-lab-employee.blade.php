...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('lab_employee.dashboard') }}">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="#">
                    ...
                    <span class="side-menu__label">Laboratory Reports</span>
                    <i class="angle fe fe-chevron-down"></i>
                </a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices_laboratorie_employee.index') }}">List of Reports</a></li>
                    <li><a class="slide-item" href="{{ route('completed_invoices') }}">Completed Reports</a></li>
                </ul>
            </li>
        </ul>
    </div>
