                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">Single Service Invoice</h1>
                            <div class="billed-from">
                                <h6>Single Service Invoice</h6>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>Department</span> <span></span>{{ Request::get('department_id') }}</p>
                            </div>
                        </div>
